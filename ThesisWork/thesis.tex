...
\title{U-Sem, a platform for augmented user modelling} % CHANGE TO YOUR TITLE
...
\colophon{\noindent\copyright{} 2013 \theauthor. Coverpicture: Web Information Systems Group, TU Delft.}
...
\global\long\def\chaptername{Appendix} 
 \include{apendix/prioritization/prioritization-questionare}
 \include{apendix/dtd/appendixDTD}
 \include{apendix/PluginTutorial/UsemPluginTutorial}
 \include{apendix/dataServiceTransf/serviceTransf}
\end{document}
